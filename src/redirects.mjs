export const LEGACY_REDIRECTS = Object.freeze({
  ...
  "/privacy/rss-finder/": "/privacy/rss-crawler/",
  "/tools/find-rss-feed-from-website": "/apps/rss-crawler/",
  "/tools/rss-feed-finder-for-windows": "/apps/rss-crawler/",
  "/tools/find-hidden-rss-feeds": "/apps/rss-crawler/",
  "/tools/export-rss-feeds-to-csv": "/apps/rss-crawler/",
  "/tools/rss-crawler-for-research": "/apps/rss-crawler/",
